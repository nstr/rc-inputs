  ...
  _createClass(Select, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          "ul",
          { className: this.state.isOpen ? "list open" : "list", id: "list-" + this.state.id },
          this.props.options.length > 0 ? this.props.options.map(function (option, index) {
            ...
            return _react2.default.createElement(
              "li",
              (_React$createElement = { key: _this2.state.id + "-option-" + index,
                style: option.style,
                className: classNames.join(" ")
              }, _defineProperty(_React$createElement, "style", option.style), _defineProperty(_React$createElement, "onClick", _this2.selectOption.bind(_this2, option, index)), _React$createElement),
              option.option ? option.option : option
            );
          }) : this.props.listPlaceholder ? _react2.default.createElement(
            "li",
            _defineProperty({ style: this.props.listPlaceholder.style,
...
Select.propTypes = {
  ...
  listPlaceholder: _react2.default.PropTypes.any
};