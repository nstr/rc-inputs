    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        !!this.props.autocomplete && this.props.autocomplete.map(function (item, index) {
          ...
          return _react2.default.createElement(
            "li",
            { key: "item-" + index, className: (0, _classnames2.default)("tag", "item", item.className), style: item.style },
            _react2.default.createElement(
              "a",
              _extends({ className: "name" }, props, { onClick: _this2.onSelect.bind(_this2, item) }),
