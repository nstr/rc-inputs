  ...
  _createClass(TextInput, [{
    ...
    value: function handleData(e) {
      ...
      if (this.props.onKeyClick && this.props.clickableKeys) {
        this.props.clickableKeys.forEach(function (key) {
          if (key === e.keyCode) _this2.props.onKeyClick(e.target.value);
        });
      }
    }
  }, {
    ...
    value: function render() {
      var inputAutoComplete = typeof this.props.autoComplete !== "boolean" ? false : this.props.autoComplete;
      var input = _react2.default.createElement("input", { type: this.props.type ? this.props.type : "text",
        ref: "input",
      ...
      if (typeof this.props.autoComplete !== "boolean") {
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            "ul",
            { className: "" },
            this.props.autoComplete.map(function (item, index) {
              return _react2.default.createElement(
                "li",
                { key: index },
                item
